...
scenario="PictureBADE_EEGshort";
pcl_file = "PictureBADE_EEGshort.pcl";
...
stimulus_event{
	picture {text{caption = "2"; font_size = 44;} two; x = 0; y = $img_y;};
		...
		duration = 1000;};
stimulus_event{
	picture {text {caption = "1"; font_size = 44;} one; x = 0; y = $img_y;};
		deltat = 1000;
		duration = 1000;};
}countdown_trial;
...
trial{
	...
	picture {text {caption = "debug your pcl file"; } img_txt ;	x=$text_x ; y=$text_y;
				bitmap { filename = "alarm clock_img3.png"; preload = true; height = 225; scale_factor = scale_to_height;} img ; x=$img_x;y=$img_y;
